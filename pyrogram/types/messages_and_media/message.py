...
class Message(Object, Update):
    ...
    Parameters:
        ...
        via_bot (:obj:`~pyrogram.types.User`, *optional*):
    ...
    def __init__(
        ...
        *,
        ...
        paid_message_price_changed: "types.PaidMessagePriceChanged" | None = None,
        todo_tasks_added: "types.TodoTasksAdded" | None = None,
        todo_tasks_completed: "types.TodoTasksCompleted" | None = None,
        todo_tasks_incompleted: "types.TodoTasksIncompleted" | None = None,
        invoice: "types.Invoice" | None = None,
        story: Union["types.MessageStory", "types.Story"] | None = None,
        ...
        external_reply: Optional["types.ExternalReplyInfo"] | None = None,
